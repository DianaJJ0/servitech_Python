  ...
  if (form) {
    ...
    form.addEventListener("submit", function (e) {
      ...
      if (isValid) {
        ...
        fetch("http://127.0.0.1:8080/usuarios/api/registro/", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            username: nombreInput.value,
            email: emailInput.value,
            telefono: "", // Puedes agregar un input para teléfono si lo deseas
            direccion: "", // Puedes agregar un input para dirección si lo deseas
